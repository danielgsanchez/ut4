...
?>
        <section>
            <article>
                    <?php
                    if ((isset($_REQUEST["cambiarDatos"])) && (!empty($_REQUEST["tlf"])) && (!empty($_REQUEST["dir"])) && (!empty($_REQUEST["email"]))){
